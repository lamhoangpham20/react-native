...
import {
	...
	TouchableOpacity, Button, RefreshControl, Dimensions
} from 'react-native';
		...
		return (
			<ScrollView style={styles.container}>
				<View style={styles.view}>
					...
					<View style={styles.forProductInfo}><Text style={styles.textForDes}> - {item.Description}</Text></View>
					<View style={styles.forWordDescription2}><Text style={styles.textWordDes}>Category</Text></View>
					<View style={styles.forProductInfo}><Text style={styles.textForDes}> - {item.Category}</Text></View>
					<View style={styles.forWordDescription2}><Text style={styles.textWordDes}>Location</Text></View>
					<View style={styles.forProductInfo}><Text style={styles.textForDes}> - {item.Location}</Text></View>
